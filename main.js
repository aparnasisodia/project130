...
function draw(){
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_Peter_pan == false){
            ...
            console.log("𝕊𝕠𝕟𝕘 ℕ𝕒𝕞𝕖 : ℙ𝕖𝕥𝕖𝕣 ℙ𝕒𝕟 𝕊𝕠𝕟𝕘");
            document.getElementById("song_id").innerHTML = "𝕊𝕠𝕟𝕘 ℕ𝕒𝕞𝕖 : ℙ𝕖𝕥𝕖𝕣 ℙ𝕒𝕟 𝕊𝕠𝕟𝕘";
        }
    }
    ...
    if(scorerightWrist > 0.2){
        ...
        if(song_Harry_potter_theme == false){
            ...
            console.log("𝕊𝕠𝕟𝕘 ℕ𝕒𝕞𝕖: ℍ𝕒𝕣𝕣𝕪 ℙ𝕠𝕥𝕥𝕖𝕣 𝕋𝕙𝕖𝕞𝕖 𝕊𝕠𝕟𝕘 ");
            document.getElementById("song_id").innerHTML = "𝕊𝕠𝕟𝕘 ℕ𝕒𝕞𝕖: ℍ𝕒𝕣𝕣𝕪 ℙ𝕠𝕥𝕥𝕖𝕣 𝕋𝕙𝕖𝕞𝕖 𝕊𝕠𝕟𝕘 ";
        }
    }
}
